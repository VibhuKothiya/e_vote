            ...
            <div className="row">
                ...
                <div className="col-6 d-flex justify-content-center align-items-center">
                    <div className="form" style={{width : '350px'}}>
                        <form onSubmit={(e) => handleSubmit(e)} className='border rounded-4 p-3'>
                            <h2 className='mb-4'>Login</h2>
                            <label className='mb-2 d-flex justify-content-start'>Mobile No.</label><input onChange={inputHandle } placeholder='Enter Mobile No.' className='mb-2 p-1 rounded d-flex justify-content-start' type='text' style={{width: '320px'}}></input>
                            <label className='mb-2 d-flex justify-content-start'>User Name</label><input onChange={inputHandle } placeholder='Enter Name' className='mb-2 p-1 rounded d-flex justify-content-start' type='text' style={{width: '320px'}}></input>
                            <label className='mb-2 d-flex justify-content-start'>Password:</label><input onChange={inputHandle } placeholder='Enter password' className='mb-3 p-1 rounded d-flex justify-content-start' type='password' style={{width: '320px'}}></input>
                           <Link to='/Deshboard'> <button className='rounded text-white ps-5 pe-5 mb-3 mt-4' style={{ backgroundColor: "#1a257e", width : '320px', textAlign: 'center' }}>Submit</button></Link>
                        </form>
                    </div>
                </div>
            </div>
